 ...
 * </p>
 * <ul>
 *   <li>{@link intermModel.impl.IntermSiteImpl#getName <em>Name</em>}</li>
 *   <li>{@link intermModel.impl.IntermSiteImpl#getSiteStates <em>Site States</em>}</li>
 *   <li>{@link intermModel.impl.IntermSiteImpl#getParent <em>Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntermSiteImpl extends MinimalEObjectImpl.Container implements IntermSite {
	...
	protected EClass eStaticClass() {
		return IntermModelPackage.Literals.INTERM_SITE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IntermModelPackage.INTERM_SITE__NAME, oldName, name));
	}
	...
	public EList<IntermSiteState> getSiteStates() {
		if (siteStates == null) {
			siteStates = new EObjectContainmentEList<IntermSiteState>(IntermSiteState.class, this,
					IntermModelPackage.INTERM_SITE__SITE_STATES);
		}
		return siteStates;
	}
	...
	public IntermAgent getParent() {
		if (parent != null && parent.eIsProxy()) {
			...
			if (parent != oldParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IntermModelPackage.INTERM_SITE__PARENT,
							oldParent, parent));
			}
		}
		return parent;
	...
	public void setParent(IntermAgent newParent) {
		...
		parent = newParent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IntermModelPackage.INTERM_SITE__PARENT, oldParent,
					parent));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case IntermModelPackage.INTERM_SITE__SITE_STATES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IntermModelPackage.INTERM_SITE__NAME:
			return getName();
		case IntermModelPackage.INTERM_SITE__SITE_STATES:
			return getSiteStates();
		case IntermModelPackage.INTERM_SITE__PARENT:
			if (resolve)
				return getParent();
