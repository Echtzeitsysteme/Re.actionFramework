...
import intermModel.BindingState;
...
import intermModel.IntermInitialisation;
import intermModel.IntermModelFactory;
 ...
 * @generated
 */
public class IntermModelPackageImpl extends EPackageImpl implements IntermModelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see intermModel.IntermModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private IntermModelPackageImpl() {
		super(eNS_URI, IntermModelFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link IntermModelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static IntermModelPackage init() {
		if (isInited)
			return (IntermModelPackage) EPackage.Registry.INSTANCE.getEPackage(IntermModelPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredIntermModelPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		IntermModelPackageImpl theIntermModelPackage = registeredIntermModelPackage instanceof IntermModelPackageImpl
				? (IntermModelPackageImpl) registeredIntermModelPackage
				: new IntermModelPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theIntermModelPackage.createPackageContents();

		// Initialize created meta-data
		theIntermModelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theIntermModelPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(IntermModelPackage.eNS_URI, theIntermModelPackage);
		return theIntermModelPackage;
	}
	 ...
	 */
	@Override
	public IntermModelFactory getIntermModelFactory() {
		return (IntermModelFactory) getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getIntermSite_Name(), ecorePackage.getEString(), "name", null, 1, 1, IntermSite.class,
		...
		initEAttribute(getIntermSiteInstance_BindingState(), this.getBindingState(), "bindingState", "UNSPECIFIED", 1,
				...
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIntermSiteInstance_Name(), ecorePackage.getEString(), "name", "UNTITLED", 1, 1,
		...
		initEClass(intermSiteStateEClass, IntermSiteState.class, "IntermSiteState", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getIntermSiteState_Name(), ecorePackage.getEString(), "name", null, 1, 1, IntermSiteState.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIntermPattern_AgentInstances(), this.getIntermAgentInstance(), null, "agentInstances", null,
				...
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIntermPattern_Name(), ecorePackage.getEString(), "name", null, 0, 1, IntermPattern.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(intermRuleEClass, IntermRule.class, "IntermRule", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getIntermRule_Name(), ecorePackage.getEString(), "name", null, 1, 1, IntermRule.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(intermObservableEClass, IntermObservable.class, "IntermObservable", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getIntermObservable_Name(), ecorePackage.getEString(), "name", null, 1, 1,
		...
		initEReference(getIntermAgent_Sites(), this.getIntermSite(), null, "sites", null, 0, -1, IntermAgent.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIntermAgent_Name(), ecorePackage.getEString(), "name", null, 1, 1, IntermAgent.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIntermediateModel_PatternContainer(), this.getPatternContainer(), null, "patternContainer",
				...
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIntermediateModel_Name(), ecorePackage.getEString(), "name", "UNTITLED", 0, 1,
		...
		initEReference(getIntermAgentInstance_InstanceOf(), this.getIntermAgent(), null, "instanceOf", null, 1, 1,
				...
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIntermAgentInstance_Name(), ecorePackage.getEString(), "name", "UNTITLED", 1, 1,
				IntermAgentInstance.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIntermAgentInstance_Local(), ecorePackage.getEBoolean(), "local", null, 0, 1,
				IntermAgentInstance.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
