 ...
 * </p>
 * <ul>
 *   <li>{@link intermModel.impl.IntermSiteInstanceImpl#getInstanceOf <em>Instance Of</em>}</li>
 *   <li>{@link intermModel.impl.IntermSiteInstanceImpl#getNotBoundTo <em>Not Bound To</em>}</li>
 *   <li>{@link intermModel.impl.IntermSiteInstanceImpl#getBoundTo <em>Bound To</em>}</li>
 *   <li>{@link intermModel.impl.IntermSiteInstanceImpl#getBindingState <em>Binding State</em>}</li>
 *   <li>{@link intermModel.impl.IntermSiteInstanceImpl#getName <em>Name</em>}</li>
 *   <li>{@link intermModel.impl.IntermSiteInstanceImpl#getState <em>State</em>}</li>
 *   <li>{@link intermModel.impl.IntermSiteInstanceImpl#getParent <em>Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntermSiteInstanceImpl extends MinimalEObjectImpl.Container implements IntermSiteInstance {
	...
	protected EClass eStaticClass() {
		return IntermModelPackage.Literals.INTERM_SITE_INSTANCE;
	}
			...
			if (instanceOf != oldInstanceOf) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							IntermModelPackage.INTERM_SITE_INSTANCE__INSTANCE_OF, oldInstanceOf, instanceOf));
			}
		}
		return instanceOf;
	}
	...
	public void setInstanceOf(IntermSite newInstanceOf) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IntermModelPackage.INTERM_SITE_INSTANCE__INSTANCE_OF,
	...
	public EList<IntermSiteInstance> getNotBoundTo() {
		if (notBoundTo == null) {
			notBoundTo = new EObjectResolvingEList<IntermSiteInstance>(IntermSiteInstance.class, this,
					IntermModelPackage.INTERM_SITE_INSTANCE__NOT_BOUND_TO);
		}
		return notBoundTo;
	}
	...
	public IntermSiteInstance getBoundTo() {
		if (boundTo != null && boundTo.eIsProxy()) {
			...
			if (boundTo != oldBoundTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							IntermModelPackage.INTERM_SITE_INSTANCE__BOUND_TO, oldBoundTo, boundTo));
			}
		}
		return boundTo;
	}
	...
	public void setBoundTo(IntermSiteInstance newBoundTo) {
		...
		boundTo = newBoundTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IntermModelPackage.INTERM_SITE_INSTANCE__BOUND_TO,
					oldBoundTo, boundTo));
	}
	...
	public void setBindingState(BindingState newBindingState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IntermModelPackage.INTERM_SITE_INSTANCE__BINDING_STATE, oldBindingState, bindingState));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IntermModelPackage.INTERM_SITE_INSTANCE__NAME,
					oldName, name));
	}
	...
	public IntermSiteState getState() {
		if (state != null && state.eIsProxy()) {
			...
			if (state != oldState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							IntermModelPackage.INTERM_SITE_INSTANCE__STATE, oldState, state));
			}
		}
		return state;
	}
	...
	public void setState(IntermSiteState newState) {
		...
		state = newState;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IntermModelPackage.INTERM_SITE_INSTANCE__STATE,
					oldState, state));
	}
	...
	public IntermAgentInstance getParent() {
		if (parent != null && parent.eIsProxy()) {
			...
			if (parent != oldParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							IntermModelPackage.INTERM_SITE_INSTANCE__PARENT, oldParent, parent));
			}
		}
		return parent;
	}
	...
	public void setParent(IntermAgentInstance newParent) {
		...
		parent = newParent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IntermModelPackage.INTERM_SITE_INSTANCE__PARENT,
					oldParent, parent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IntermModelPackage.INTERM_SITE_INSTANCE__INSTANCE_OF:
			if (resolve)
				return getInstanceOf();
			return basicGetInstanceOf();
		case IntermModelPackage.INTERM_SITE_INSTANCE__NOT_BOUND_TO:
			return getNotBoundTo();
		case IntermModelPackage.INTERM_SITE_INSTANCE__BOUND_TO:
			if (resolve)
				return getBoundTo();
			return basicGetBoundTo();
		case IntermModelPackage.INTERM_SITE_INSTANCE__BINDING_STATE:
			return getBindingState();
		case IntermModelPackage.INTERM_SITE_INSTANCE__NAME:
			return getName();
		case IntermModelPackage.INTERM_SITE_INSTANCE__STATE:
			if (resolve)
				return getState();
			return basicGetState();
		case IntermModelPackage.INTERM_SITE_INSTANCE__PARENT:
			if (resolve)
				return getParent();
