 ...
 * </p>
 * <ul>
 *   <li>{@link intermModel.impl.PatternContainerImpl#getPatterns <em>Patterns</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PatternContainerImpl extends MinimalEObjectImpl.Container implements PatternContainer {
	...
	protected EClass eStaticClass() {
		return IntermModelPackage.Literals.PATTERN_CONTAINER;
	}
	...
	public EList<IntermPattern> getPatterns() {
		if (patterns == null) {
			patterns = new EObjectContainmentEList<IntermPattern>(IntermPattern.class, this,
					IntermModelPackage.PATTERN_CONTAINER__PATTERNS);
		}
		return patterns;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case IntermModelPackage.PATTERN_CONTAINER__PATTERNS:
