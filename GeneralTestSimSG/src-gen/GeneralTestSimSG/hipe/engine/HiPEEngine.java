...
import GeneralTestSimSG.hipe.engine.actor.junction.injectivity_131_junction;
...
public class HiPEEngine implements IHiPEEngine{
	...
	public void createJunctionNodes() {
		...
		classes.put("simpleBindingBwd_183_nacjunction", GenericNACJunctionActor.class);
		classes.put("simpleBindingBwd_184_nacjunction", GenericNACJunctionActor.class);
		classes.put("simpleBindingBwd_185_nacjunction", GenericNACJunctionActor.class);
		classes.put("simpleBindingBwd_186_nacjunction", GenericNACJunctionActor.class);
		classes.put("simpleBindingBwd_187_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("selfBindingBwd_189_nacjunction", GenericNACJunctionActor.class);
		classes.put("selfBindingBwd_190_nacjunction", GenericNACJunctionActor.class);
		classes.put("selfBindingBwd_191_nacjunction", GenericNACJunctionActor.class);
		classes.put("selfBindingBwd_192_nacjunction", GenericNACJunctionActor.class);
		classes.put("selfBindingBwd_193_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("synthDegPartial_196_nacjunction", GenericNACJunctionActor.class);
		classes.put("synthDegPartial_197_nacjunction", GenericNACJunctionActor.class);
		classes.put("synthDegPartial_198_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("unspecTest_199_nacjunction", GenericNACJunctionActor.class);
		classes.put("unspecTest_200_nacjunction", GenericNACJunctionActor.class);
		classes.put("unspecTest_201_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("simpleSynthesis_202_nacjunction", GenericNACJunctionActor.class);
		classes.put("simpleSynthesis_203_nacjunction", GenericNACJunctionActor.class);
		classes.put("simpleSynthesis_204_nacjunction", GenericNACJunctionActor.class);
		classes.put("simpleSynthesis_205_nacjunction", GenericNACJunctionActor.class);
		classes.put("unspecifiedStateChange_126_junction", GenericJunctionActor.class);
		classes.put("injectivity_133_junction", GenericJunctionActor.class);
		classes.put("injectivity_131_junction", injectivity_131_junction.class);
		classes.put("injectivity_206_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivity_207_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivity_208_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivity_209_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivity_210_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("injectivityBwd_217_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivityBwd_218_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivityBwd_219_nacjunction", GenericNACJunctionActor.class);
		classes.put("A_cFree_220_nacjunction", GenericNACJunctionActor.class);
		classes.put("A_cFree_221_nacjunction", GenericNACJunctionActor.class);
		classes.put("A_cFree_222_nacjunction", GenericNACJunctionActor.class);
		classes.put("wildcard_144_junction", GenericJunctionActor.class);
		classes.put("wildcard_223_nacjunction", GenericNACJunctionActor.class);
		classes.put("wildcardStateChange_147_junction", GenericJunctionActor.class);
		classes.put("wildcardStateChange_224_nacjunction", GenericNACJunctionActor.class);
		classes.put("wildcardStateChangeBwd_152_junction", GenericJunctionActor.class);
		classes.put("wildcardStateChangeBwd_225_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_underspecTest_159_junction", GenericJunctionActor.class);
		classes.put("obs_underspecTest_157_junction", GenericJunctionActor.class);
		classes.put("obs_underspecTest_226_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_underspecTest_227_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_underspecTest_228_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_genericTest_165_junction", GenericJunctionActor.class);
		classes.put("obs_wildcardTest_229_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_wildcardTest_230_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_wildcardTest_231_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_aFree_232_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_aFree_233_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("obs_aFree_236_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_aFree_237_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_aFree_238_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_xFree_239_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_xFree_240_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_xFree_241_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_ax_180_junction", GenericJunctionActor.class);
	}
