...
public class HiPEEngine implements IHiPEEngine{
	...
	public void createProductionNodes() {
		...
		classes.put("conditionPattern_Ab_to_Xy_Local_production", GenericProductionActor.class);
		productionNodes2pattern.put("conditionPattern_Ab_to_Xy_Local_production", "conditionPattern_Ab_to_Xy_Local");
		classes.put("conditionPattern_Ac_to_Xy_Local_production", GenericProductionActor.class);
		productionNodes2pattern.put("conditionPattern_Ac_to_Xy_Local_production", "conditionPattern_Ac_to_Xy_Local");
		classes.put("obs_aNotXy_production", GenericProductionActor.class);
		productionNodes2pattern.put("obs_aNotXy_production", "obs_aNotXy");
		...
		classes.put("obs_aNotX_production", GenericProductionActor.class);
		productionNodes2pattern.put("obs_aNotX_production", "obs_aNotX");
	...
	public void createJunctionNodes() {
		...
		classes.put("simpleBindingBwd_214_nacjunction", GenericNACJunctionActor.class);
		classes.put("simpleBindingBwd_215_nacjunction", GenericNACJunctionActor.class);
		classes.put("simpleBindingBwd_216_nacjunction", GenericNACJunctionActor.class);
		classes.put("simpleBindingBwd_217_nacjunction", GenericNACJunctionActor.class);
		classes.put("simpleBindingBwd_218_nacjunction", GenericNACJunctionActor.class);
		classes.put("simpleBindingBwd_219_nacjunction", GenericNACJunctionActor.class);
		classes.put("simpleBindingBwd_220_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("selfBindingBwd_221_nacjunction", GenericNACJunctionActor.class);
		classes.put("selfBindingBwd_222_nacjunction", GenericNACJunctionActor.class);
		classes.put("selfBindingBwd_223_nacjunction", GenericNACJunctionActor.class);
		classes.put("selfBindingBwd_224_nacjunction", GenericNACJunctionActor.class);
		classes.put("selfBindingBwd_225_nacjunction", GenericNACJunctionActor.class);
		classes.put("selfBindingBwd_226_nacjunction", GenericNACJunctionActor.class);
		classes.put("selfBindingBwd_227_nacjunction", GenericNACJunctionActor.class);
		classes.put("selfBindingBwd_228_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("synthDegPartial_229_nacjunction", GenericNACJunctionActor.class);
		classes.put("synthDegPartial_230_nacjunction", GenericNACJunctionActor.class);
		classes.put("synthDegPartial_231_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("unspecTest_232_nacjunction", GenericNACJunctionActor.class);
		classes.put("unspecTest_233_nacjunction", GenericNACJunctionActor.class);
		classes.put("unspecTest_234_nacjunction", GenericNACJunctionActor.class);
		classes.put("unspecTest_235_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("simpleSynthesis_236_nacjunction", GenericNACJunctionActor.class);
		classes.put("simpleSynthesis_237_nacjunction", GenericNACJunctionActor.class);
		classes.put("simpleSynthesis_238_nacjunction", GenericNACJunctionActor.class);
		classes.put("simpleSynthesis_239_nacjunction", GenericNACJunctionActor.class);
		classes.put("simpleSynthesis_240_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("injectivity_241_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivity_242_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivity_243_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivity_244_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivity_245_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivity_246_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivity_247_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivity_248_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivity_249_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivity_250_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivity_251_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivity_252_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivity_253_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivity_254_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("injectivityBwd_255_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivityBwd_256_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivityBwd_257_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivityBwd_258_nacjunction", GenericNACJunctionActor.class);
		classes.put("A_cFree_259_nacjunction", GenericNACJunctionActor.class);
		classes.put("A_cFree_260_nacjunction", GenericNACJunctionActor.class);
		classes.put("A_cFree_261_nacjunction", GenericNACJunctionActor.class);
		classes.put("wildcard_150_junction", GenericJunctionActor.class);
		classes.put("wildcard_262_nacjunction", GenericNACJunctionActor.class);
		classes.put("wildcardStateChange_153_junction", GenericJunctionActor.class);
		classes.put("wildcardStateChange_263_nacjunction", GenericNACJunctionActor.class);
		classes.put("wildcardStateChangeBwd_158_junction", GenericJunctionActor.class);
		classes.put("wildcardStateChangeBwd_264_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("obs_underspecTest_265_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_underspecTest_266_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_underspecTest_267_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_underspecTest_268_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_genericTest_176_junction", GenericJunctionActor.class);
		classes.put("obs_wildcardTest_269_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_wildcardTest_270_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_wildcardTest_271_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_wildcardTest_272_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("obs_underspecSynthTest_277_nacjunction", GenericNACJunctionActor.class);
		createJunctionNodes_1();
			}	
		
			private void createJunctionNodes_1() {
		classes.put("obs_underspecSynthTest_278_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_underspecSynthTest_279_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_underspecSynthTest_280_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_concreteSplitTest_192_junction", GenericJunctionActor.class);
		classes.put("obs_concreteSplitTest_281_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_concreteSplitTest_282_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_concreteSplitTest_283_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_concreteSplitTest_284_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_concreteSplitTest_285_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_concreteSplitTest_286_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_concreteSplitTest_287_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_concreteSplitTest_288_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_concreteSplitTest_289_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_concreteSplitTest_290_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_concreteSplitTest_291_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_concreteSplitTest_292_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_aNotXy_293_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_aNotXy_294_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_aNotX_295_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_aNotX_296_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_aFree_297_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_aFree_298_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_aFree_299_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_aFree_300_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_aFree_301_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_aFree_302_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_aFree_303_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_aFree_304_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_xFree_305_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_xFree_306_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_xFree_307_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_xFree_308_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_ax_211_junction", GenericJunctionActor.class);
	}
