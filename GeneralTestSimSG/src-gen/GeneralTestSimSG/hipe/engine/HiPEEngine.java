...
public class HiPEEngine implements IHiPEEngine{
	...
	public void createJunctionNodes() {
		...
		classes.put("simpleBindingBwd_176_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("selfBindingBwd_178_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("synthDegPartial_180_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("generic_102_junction", GenericJunctionActor.class);
		...
		classes.put("genericWithStateTest_124_junction", GenericJunctionActor.class);
		...
		classes.put("injectivity_184_nacjunction", GenericNACJunctionActor.class);
		...
		classes.put("injectivityBwd_188_nacjunction", GenericNACJunctionActor.class);
		classes.put("injectivityBwd_189_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_underspecTest_153_junction", GenericJunctionActor.class);
		classes.put("obs_underspecTest_149_junction", GenericJunctionActor.class);
		classes.put("obs_underspecTest_147_junction", GenericJunctionActor.class);
		classes.put("obs_underspecTest_190_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_underspecTest_191_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_genericTest_161_junction", GenericJunctionActor.class);
		classes.put("obs_genericTest_157_junction", GenericJunctionActor.class);
		classes.put("obs_aFree_192_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_aFree_193_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_xFree_194_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_xFree_195_nacjunction", GenericNACJunctionActor.class);
		classes.put("obs_ax_173_junction", GenericJunctionActor.class);
	}
