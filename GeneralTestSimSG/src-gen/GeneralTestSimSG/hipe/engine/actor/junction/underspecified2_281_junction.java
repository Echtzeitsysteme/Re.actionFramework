...
public class underspecified2_281_junction extends GenericJunctionActor{
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor, AbstractJunctionNode node) {
		ports = new LinkedList<>();
		ports.add(new PortJunction(getSelf(), name2actor.get("underspecified2_production"), this::check_constraint_50));
	}
	...
	public boolean check_constraint_50(HMatch match) {
		reactionContainer.Agent x_z_local = (reactionContainer.Agent) match.getNodes()[3];
		...
		TestcasesModel.X x = (TestcasesModel.X) match.getNodes()[2];
