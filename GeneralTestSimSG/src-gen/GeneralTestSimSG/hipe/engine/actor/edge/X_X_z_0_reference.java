...
public class X_X_z_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("injectivityBwd_189_nacjunction"), this::check_constraint_25));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("injectivity_187_nacjunction"), this::check_constraint_21));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("obs_underspecTest_191_nacjunction"), this::check_constraint_27));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("obs_xFree_195_nacjunction"), this::check_constraint_31));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("simpleBindingBwd_177_nacjunction"), this::check_constraint_8));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("unspecTest_182_nacjunction"), this::check_constraint_15));
