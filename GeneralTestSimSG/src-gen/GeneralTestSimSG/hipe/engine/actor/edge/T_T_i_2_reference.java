...
public class T_T_i_2_reference extends AbstractActor {
	...
	public T_T_i_2_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("bidirectionalRule_452_junction"), this::returnTrue));
	}	
