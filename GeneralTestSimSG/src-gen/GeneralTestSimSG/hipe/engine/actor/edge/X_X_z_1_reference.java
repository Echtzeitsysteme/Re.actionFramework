...
public class X_X_z_1_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("genericWithState_114_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("generic_99_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("obs_genericTest_158_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("obs_underspecTest_150_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("underspec_82_junction"), this::returnTrue));
	}	
