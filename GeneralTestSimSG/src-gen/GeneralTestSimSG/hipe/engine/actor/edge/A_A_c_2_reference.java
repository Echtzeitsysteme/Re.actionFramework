...
public class A_A_c_2_reference extends AbstractActor {
	...
	public A_A_c_2_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("bidirectionalRule_446_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("breakSpecificBond_434_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("complexStateChanges_471_junction"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("conditionPattern_Ac_to_LocalAgent_X_production"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("generic1_549_nacjunction"), this::returnTrue));
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("injectivity_487_junction"), this::returnTrue));
	}	
