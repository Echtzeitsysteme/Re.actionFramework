...
public class X_X_z_2_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("bidirectionalRuleBwd_473_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("bidirectionalRule_450_junction"), this::returnTrue));
	}	
