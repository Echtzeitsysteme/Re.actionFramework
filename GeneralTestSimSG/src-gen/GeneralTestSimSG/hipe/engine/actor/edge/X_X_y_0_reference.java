...
public class X_X_y_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("injectivityBwd_188_nacjunction"), this::check_constraint_24));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("injectivity_186_nacjunction"), this::check_constraint_20));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("obs_underspecTest_190_nacjunction"), this::check_constraint_26));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("obs_xFree_194_nacjunction"), this::check_constraint_30));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("unspecTest_181_nacjunction"), this::check_constraint_14));
