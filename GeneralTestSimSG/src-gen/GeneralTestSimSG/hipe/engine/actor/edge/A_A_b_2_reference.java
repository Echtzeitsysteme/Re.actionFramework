...
public class A_A_b_2_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("conditionPattern_Ab_to_Xz_state_p_406_junction"), this::returnTrue));
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("injectivity_487_junction"), this::returnTrue));
