...
public class A_A_b_2_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("injectivityBwd_142_junction"), this::check_constraint_22));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("injectivityBwd_142_junction"), this::check_constraint_23));
	}	
