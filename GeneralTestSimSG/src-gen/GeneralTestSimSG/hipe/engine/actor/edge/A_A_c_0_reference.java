...
public class A_A_c_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("bidirectionalRuleBwd_566_nacjunction"), this::check_constraint_77));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("bidirectionalRule_457_junction"), this::check_constraint_73));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("degradation2_540_nacjunction"), this::check_constraint_34));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("freeAgentsBind2_554_nacjunction"), this::check_constraint_65));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("freeAgentsBind_550_nacjunction"), this::check_constraint_61));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("partialDegradation2_544_nacjunction"), this::check_constraint_38));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("simpleBind1State1_512_nacjunction"), this::check_constraint_16));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("simpleBind1State2_516_nacjunction"), this::check_constraint_20));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("simpleBind1_1_504_nacjunction"), this::check_constraint_8));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("simpleBind1_2_508_nacjunction"), this::check_constraint_12));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("simpleBind2State1_521_nacjunction"), this::check_constraint_25));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("simpleBind2State2_523_nacjunction"), this::check_constraint_27));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("simpleBind2State3_525_nacjunction"), this::check_constraint_29));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("simpleBind2State4_527_nacjunction"), this::check_constraint_31));
	...
	public boolean check_constraint_77(EdgeMatch edge) {
		TestcasesModel.A src = (TestcasesModel.A) edge.source();
		reactionContainer.Agent trg = (reactionContainer.Agent) edge.target();
		boolean predicate = !src.equals(trg);
		edge.setConstraintSatisfied(predicate);
