...
public class A_A_b_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("injectivity_185_nacjunction"), this::check_constraint_18));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("injectivity_186_nacjunction"), this::check_constraint_19));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("obs_aFree_193_nacjunction"), this::check_constraint_28));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("selfBindingBwd_179_nacjunction"), this::check_constraint_11));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("simpleBindingBwd_177_nacjunction"), this::check_constraint_7));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("simpleSynthesis_184_nacjunction"), this::check_constraint_16));
	}	
