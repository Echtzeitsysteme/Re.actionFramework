...
public class A_A_b_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("bidirectionalRuleBwd_565_nacjunction"), this::check_constraint_76));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("degradation2_539_nacjunction"), this::check_constraint_33));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("freeAgentsBind2_553_nacjunction"), this::check_constraint_64));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("freeAgentsBind_549_nacjunction"), this::check_constraint_60));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("partialDegradation2_543_nacjunction"), this::check_constraint_37));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("simpleBind1State1_511_nacjunction"), this::check_constraint_15));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("simpleBind1State2_515_nacjunction"), this::check_constraint_19));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("simpleBind1_1_503_nacjunction"), this::check_constraint_7));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("simpleBind1_2_507_nacjunction"), this::check_constraint_11));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("simpleBind2_519_nacjunction"), this::check_constraint_23));
	...
	public boolean check_constraint_76(EdgeMatch edge) {
		TestcasesModel.A src = (TestcasesModel.A) edge.source();
		reactionContainer.Agent trg = (reactionContainer.Agent) edge.target();
		boolean predicate = !src.equals(trg);
		edge.setConstraintSatisfied(predicate);
