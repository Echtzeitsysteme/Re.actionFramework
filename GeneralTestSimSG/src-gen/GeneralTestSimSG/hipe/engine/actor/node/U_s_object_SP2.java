...
public class U_s_object_SP2 extends AbstractActor {
	
	private List<Port<TestcasesModel.U_s>> ports;		
		
	public U_s_object_SP2() {
	}
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeMatchRight<TestcasesModel.U_s>(getSelf(), name2actor.get("simpleSynthesis_128_junction"), this::returnTrue));
