...
public class X_object_SP4 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeMatchRight<TestcasesModel.X>(getSelf(), name2actor.get("unspecified3_327_junction"), this::returnTrue));
	}
