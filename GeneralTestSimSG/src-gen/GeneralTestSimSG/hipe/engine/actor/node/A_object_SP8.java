...
public class A_object_SP8 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeMatchRight<TestcasesModel.A>(getSelf(), name2actor.get("unspecified4_334_junction"), this::returnTrue));
	}
