...
public class P_s_object_SP6 extends AbstractActor {
	
	private List<Port<TestcasesModel.P_s>> ports;		
		
	public P_s_object_SP6() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeMatchLeft<TestcasesModel.P_s>(getSelf(), name2actor.get("generic7_377_junction"), this::returnTrue));
