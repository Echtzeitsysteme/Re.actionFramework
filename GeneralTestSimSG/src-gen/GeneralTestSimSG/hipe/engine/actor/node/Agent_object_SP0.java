...
public class Agent_object_SP0 extends AbstractActor {
	
	private List<Port<reactionContainer.Agent>> ports;		
		
	public Agent_object_SP0() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<reactionContainer.Agent>(getSelf(), name2actor.get("A_A_b_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<reactionContainer.Agent>(getSelf(), name2actor.get("T_T_i_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<reactionContainer.Agent>(getSelf(), name2actor.get("X_X_y_0_reference"), this::returnTrue));
	}
