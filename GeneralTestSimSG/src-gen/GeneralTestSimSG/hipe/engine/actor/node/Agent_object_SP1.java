...
public class Agent_object_SP1 extends AbstractActor {
	
	private List<Port<reactionContainer.Agent>> ports;		
		
	public Agent_object_SP1() {
	}

	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortNodeRight<reactionContainer.Agent>(getSelf(), name2actor.get("A_A_c_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<reactionContainer.Agent>(getSelf(), name2actor.get("T_T_j_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<reactionContainer.Agent>(getSelf(), name2actor.get("X_X_z_0_reference"), this::returnTrue));
	}
