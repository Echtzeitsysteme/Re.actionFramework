...
public class P_s_object_SP4 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeMatchRight<TestcasesModel.P_s>(getSelf(), name2actor.get("bidirectionalRuleBwd_466_junction"), this::returnTrue));
		ports.add(new PortNodeMatchLeft<TestcasesModel.P_s>(getSelf(), name2actor.get("simpleBind3State1_89_junction"), this::returnTrue));
