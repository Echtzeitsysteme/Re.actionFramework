...
public class X_object_SP3 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeMatchLeft<TestcasesModel.X>(getSelf(), name2actor.get("obs_xFree_195_nacjunction"), this::returnTrue));
		ports.add(new PortNodeMatchLeft<TestcasesModel.X>(getSelf(), name2actor.get("unspecTest_94_junction"), this::returnTrue));
	}
