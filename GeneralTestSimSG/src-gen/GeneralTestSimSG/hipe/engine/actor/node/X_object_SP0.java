...
public class X_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeMatchRight<TestcasesModel.X>(getSelf(), name2actor.get("injectivity_138_junction"), this::returnTrue));
		ports.add(new PortNodeMatchLeft<TestcasesModel.X>(getSelf(), name2actor.get("obs_ax_174_junction"), this::returnTrue));
	}
