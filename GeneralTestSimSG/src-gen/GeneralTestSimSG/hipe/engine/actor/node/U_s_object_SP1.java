...
public class U_s_object_SP1 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeMatchRight<TestcasesModel.U_s>(getSelf(), name2actor.get("forbiddenBondState_416_junction"), this::returnTrue));
		ports.add(new PortNodeMatchLeft<TestcasesModel.U_s>(getSelf(), name2actor.get("simpleSplit1State2_140_junction"), this::returnTrue));
		ports.add(new PortNodeMatch<TestcasesModel.U_s>(getSelf(), name2actor.get("synthesisSingle8_production"), this::returnTrue));
	}
