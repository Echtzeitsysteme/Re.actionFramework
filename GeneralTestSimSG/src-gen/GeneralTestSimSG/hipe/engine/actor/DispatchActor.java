...
public class DispatchActor extends AbstractActor {
	...
	private void initializeAddEdge() {
		...
		feature2addEdgeConsumer.put(TestcasesModel.TestcasesModelPackage.eINSTANCE.getA_A_c_A_b(), notification -> {
			util.newMessage();
			name2actor.get("A_A_c_A_b_0_reference").tell(new ReferenceAdded<TestcasesModel.A, TestcasesModel.A>((TestcasesModel.A) notification.getNotifier(), (TestcasesModel.A) notification.getNewValue()), getSelf());
		});
		...
		feature2addEdgeConsumer.put(TestcasesModel.TestcasesModelPackage.eINSTANCE.getX_X_z_A_b(), notification -> {
			util.newMessage();
			name2actor.get("X_X_z_A_b_0_reference").tell(new ReferenceAdded<TestcasesModel.X, TestcasesModel.A>((TestcasesModel.X) notification.getNotifier(), (TestcasesModel.A) notification.getNewValue()), getSelf());
		});
		feature2addEdgeConsumer.put(TestcasesModel.TestcasesModelPackage.eINSTANCE.getX_X_y_A_b(), notification -> {
			util.newMessage();
			name2actor.get("X_X_y_A_b_0_reference").tell(new ReferenceAdded<TestcasesModel.X, TestcasesModel.A>((TestcasesModel.X) notification.getNotifier(), (TestcasesModel.A) notification.getNewValue()), getSelf());
		});
		feature2addEdgeConsumer.put(TestcasesModel.TestcasesModelPackage.eINSTANCE.getX_X_z_A_c(), notification -> {
			util.newMessage();
			name2actor.get("X_X_z_A_c_0_reference").tell(new ReferenceAdded<TestcasesModel.X, TestcasesModel.A>((TestcasesModel.X) notification.getNotifier(), (TestcasesModel.A) notification.getNewValue()), getSelf());
		});
		feature2addEdgeConsumer.put(TestcasesModel.TestcasesModelPackage.eINSTANCE.getX_X_y_A_c(), notification -> {
			util.newMessage();
			name2actor.get("X_X_y_A_c_0_reference").tell(new ReferenceAdded<TestcasesModel.X, TestcasesModel.A>((TestcasesModel.X) notification.getNotifier(), (TestcasesModel.A) notification.getNewValue()), getSelf());
		});
	...
	private void initializeRemoveEdge() {
		...
		feature2removeEdgeConsumer.put(TestcasesModel.TestcasesModelPackage.eINSTANCE.getA_A_c_A_b(), notification -> {
			util.newMessage();
			name2actor.get("A_A_c_A_b_0_reference").tell(new ReferenceDeleted<TestcasesModel.A, TestcasesModel.A>((TestcasesModel.A) notification.getNotifier(), (TestcasesModel.A) notification.getOldValue()), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(TestcasesModel.TestcasesModelPackage.eINSTANCE.getX_X_z_A_b(), notification -> {
			util.newMessage();
			name2actor.get("X_X_z_A_b_0_reference").tell(new ReferenceDeleted<TestcasesModel.X, TestcasesModel.A>((TestcasesModel.X) notification.getNotifier(), (TestcasesModel.A) notification.getOldValue()), getSelf());
		});
		feature2removeEdgeConsumer.put(TestcasesModel.TestcasesModelPackage.eINSTANCE.getX_X_y_A_b(), notification -> {
			util.newMessage();
			name2actor.get("X_X_y_A_b_0_reference").tell(new ReferenceDeleted<TestcasesModel.X, TestcasesModel.A>((TestcasesModel.X) notification.getNotifier(), (TestcasesModel.A) notification.getOldValue()), getSelf());
		});
		feature2removeEdgeConsumer.put(TestcasesModel.TestcasesModelPackage.eINSTANCE.getX_X_z_A_c(), notification -> {
			util.newMessage();
			name2actor.get("X_X_z_A_c_0_reference").tell(new ReferenceDeleted<TestcasesModel.X, TestcasesModel.A>((TestcasesModel.X) notification.getNotifier(), (TestcasesModel.A) notification.getOldValue()), getSelf());
		});
		feature2removeEdgeConsumer.put(TestcasesModel.TestcasesModelPackage.eINSTANCE.getX_X_y_A_c(), notification -> {
			util.newMessage();
			name2actor.get("X_X_y_A_c_0_reference").tell(new ReferenceDeleted<TestcasesModel.X, TestcasesModel.A>((TestcasesModel.X) notification.getNotifier(), (TestcasesModel.A) notification.getOldValue()), getSelf());
		});
