...
import GKL_created_test.api.matches.T_x_K_aBoundTrgMatch;
import GKLModel.K;
...
public class T_x_K_aBoundTrgRule extends GraphTransformationRule<T_x_K_aBoundTrgMatch, T_x_K_aBoundTrgRule> {
	 ...
	 *            the interpreter
	 */
	public T_x_K_aBoundTrgRule(final GKL_created_testAPI api, final GraphTransformationInterpreter interpreter) {
