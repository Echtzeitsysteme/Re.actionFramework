...
public class T_object_SP2 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeMatchLeft<GKLModel.T>(getSelf(), name2actor.get("KT_x_13_junction"), this::returnTrue));
		ports.add(new PortNodeLeft<GKLModel.T>(getSelf(), name2actor.get("T_T_x_p_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<GKLModel.T>(getSelf(), name2actor.get("T_T_y_1_reference"), this::returnTrue));
	}
