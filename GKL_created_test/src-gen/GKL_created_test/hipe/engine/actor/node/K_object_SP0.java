...
public class K_object_SP0 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeLeft<GKLModel.K>(getSelf(), name2actor.get("K_K_a_0_reference"), this::returnTrue));
		ports.add(new PortNodeRight<GKLModel.K>(getSelf(), name2actor.get("T_T_x_1_reference"), this::returnTrue));
		ports.add(new PortNodeRight<GKLModel.K>(getSelf(), name2actor.get("T_T_y_1_reference"), this::returnTrue));
	}
