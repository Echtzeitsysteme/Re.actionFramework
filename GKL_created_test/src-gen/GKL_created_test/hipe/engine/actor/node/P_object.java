...
public class P_object extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeMatchLeft<GKLModel.P>(getSelf(), name2actor.get("PT_x_41_junction"), this::returnTrue));
		ports.add(new PortNodeMatchRight<GKLModel.P>(getSelf(), name2actor.get("PT_y_55_junction"), this::returnTrue));
		ports.add(new PortNodeLeft<GKLModel.P>(getSelf(), name2actor.get("P_P_a_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<GKLModel.P>(getSelf(), name2actor.get("P_P_a_1_reference"), this::returnTrue));
	}
