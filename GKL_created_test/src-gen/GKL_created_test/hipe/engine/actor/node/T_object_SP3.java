...
public class T_object_SP3 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeMatchLeft<GKLModel.T>(getSelf(), name2actor.get("PT_y_55_junction"), this::returnTrue));
		ports.add(new PortNodeLeft<GKLModel.T>(getSelf(), name2actor.get("T_T_x_1_reference"), this::returnTrue));
