...
public class U_s_object extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeMatchLeft<GKLModel.U_s>(getSelf(), name2actor.get("Tu_x_47_junction"), this::returnTrue));
		ports.add(new PortNodeMatchLeft<GKLModel.U_s>(getSelf(), name2actor.get("Tu_y_61_junction"), this::returnTrue));
	}
