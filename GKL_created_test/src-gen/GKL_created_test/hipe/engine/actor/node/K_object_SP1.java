...
public class K_object_SP1 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeMatchRight<GKLModel.K>(getSelf(), name2actor.get("KT_x_13_junction"), this::returnTrue));
		ports.add(new PortNodeMatchLeft<GKLModel.K>(getSelf(), name2actor.get("KT_y_27_junction"), this::returnTrue));
	}
