...
public class P_s_object extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeMatchLeft<GKLModel.P_s>(getSelf(), name2actor.get("Tp_x_19_junction"), this::returnTrue));
		ports.add(new PortNodeMatchLeft<GKLModel.P_s>(getSelf(), name2actor.get("Tp_y_33_junction"), this::returnTrue));
	}
