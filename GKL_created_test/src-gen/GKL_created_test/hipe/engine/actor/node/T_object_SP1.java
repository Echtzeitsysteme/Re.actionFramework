...
public class T_object_SP1 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeMatchRight<GKLModel.T>(getSelf(), name2actor.get("KT_y_27_junction"), this::returnTrue));
		ports.add(new PortNodeRight<GKLModel.T>(getSelf(), name2actor.get("P_P_a_1_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<GKLModel.T>(getSelf(), name2actor.get("T_T_y_0_reference"), this::returnTrue));
	}
