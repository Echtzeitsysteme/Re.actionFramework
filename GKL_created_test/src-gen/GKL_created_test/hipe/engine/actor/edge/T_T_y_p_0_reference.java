...
public class T_T_y_p_0_reference extends AbstractActor {
	...
	public T_T_y_p_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("T_pp_69_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("T_pp_unbound_74_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("Tu_y_63_junction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<GKLModel.T> message) {
		...
		GKLModel.P_s target = (GKLModel.P_s) message.input.getT_y_p();
