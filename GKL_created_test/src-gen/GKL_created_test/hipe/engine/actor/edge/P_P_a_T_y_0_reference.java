...
public class P_P_a_T_y_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdge(getSelf(), name2actor.get("P_a_T_yBoundSrc_production"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("P_a_T_yBoundTrg_production"), this::returnTrue));
	...
	private void leftAdded(NodeAddedLeft<GKLModel.P> message) {
		...
		GKLModel.T target = (GKLModel.T) message.input.getP_a_T_y();
