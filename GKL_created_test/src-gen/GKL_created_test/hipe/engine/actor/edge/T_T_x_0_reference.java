...
public class T_T_x_0_reference extends AbstractActor {
	...
	public T_T_x_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("KT_x_79_nacjunction"), this::check_constraint_5));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("PT_x_84_nacjunction"), this::check_constraint_10));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("T_pp_unbound_87_nacjunction"), this::check_constraint_13));
		ports.add(new PortEdge(getSelf(), name2actor.get("t_xBound_production"), this::check_constraint_2));
	}	
	...
	private void leftAdded(NodeAddedLeft<GKLModel.T> message) {
		...
		reactionContainer.Agent target = (reactionContainer.Agent) message.input.getT_x();
