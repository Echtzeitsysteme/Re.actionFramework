...
public class T_T_x_p_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("T_pp_69_junction"), this::returnTrue));
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("T_pp_unbound_74_junction"), this::returnTrue));
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("Tu_x_49_junction"), this::returnTrue));
	}	
