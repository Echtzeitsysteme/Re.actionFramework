...
public class T_T_x_u_0_reference extends AbstractActor {
	...
	public T_T_x_u_0_reference() {
	}
	
	public void initActor(InitActor m) {
		Map<String, ActorRef> name2actor = m.name2actor;
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(getSelf(), name2actor.get("Tp_x_21_junction"), this::returnTrue));
	}	
	...
	private void leftAdded(NodeAddedLeft<GKLModel.T> message) {
		...
		GKLModel.U_s target = (GKLModel.U_s) message.input.getT_x_u();
