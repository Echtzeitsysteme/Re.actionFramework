...
public class T_T_x_P_a_0_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdge(getSelf(), name2actor.get("T_x_P_aBoundSrc_production"), this::returnTrue));
		ports.add(new PortEdge(getSelf(), name2actor.get("T_x_P_aBoundTrg_production"), this::returnTrue));
	...
	private void leftAdded(NodeAddedLeft<GKLModel.T> message) {
		...
		GKLModel.P target = (GKLModel.P) message.input.getT_x_P_a();
