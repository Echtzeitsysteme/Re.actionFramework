...
public class T_T_x_1_reference extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortEdgeLeft(getSelf(), name2actor.get("Tp_x_21_junction"), this::returnTrue));
	}	
