...
public class GKLModelPackageImpl extends EPackageImpl implements GKLModelPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getP_P_a_T_x(), this.getT(), this.getT_T_x_P_a(), "P_a_T_x", null, 0, 1, GKLModel.P.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getP_P_a_T_y(), this.getT(), this.getT_T_y_P_a(), "P_a_T_y", null, 0, 1, GKLModel.P.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tEClass, GKLModel.T.class, "T", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getT_T_x_P_a(), this.getP(), this.getP_P_a_T_x(), "T_x_P_a", null, 0, 1, GKLModel.T.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getT_T_y_P_a(), this.getP(), this.getP_P_a_T_y(), "T_y_P_a", null, 0, 1, GKLModel.T.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getT_T_x_K_a(), this.getK(), this.getK_K_a_T_x(), "T_x_K_a", null, 0, 1, GKLModel.T.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getT_T_x_p(), this.getP_s(), null, "T_x_p", null, 0, 1, GKLModel.T.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getT_T_y_K_a(), this.getK(), this.getK_K_a_T_y(), "T_y_K_a", null, 0, 1, GKLModel.T.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getK_K_a_T_x(), this.getT(), this.getT_T_x_K_a(), "K_a_T_x", null, 0, 1, GKLModel.K.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getK_K_a_T_y(), this.getT(), this.getT_T_y_K_a(), "K_a_T_y", null, 0, 1, GKLModel.K.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
