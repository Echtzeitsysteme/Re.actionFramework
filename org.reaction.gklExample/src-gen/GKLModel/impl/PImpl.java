...
public class PImpl extends AgentImpl implements P {
	...
	public NotificationChain basicSetP_a_T_x(T newP_a_T_x, NotificationChain msgs) {
		...
		p_a_T_x = newP_a_T_x;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GKLModelPackage.P__PATX,
					oldP_a_T_x, newP_a_T_x);
			if (msgs == null)
				msgs = notification;
			else
	...
	public NotificationChain basicSetP_a_T_y(T newP_a_T_y, NotificationChain msgs) {
		...
		p_a_T_y = newP_a_T_y;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GKLModelPackage.P__PATY,
					oldP_a_T_y, newP_a_T_y);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
