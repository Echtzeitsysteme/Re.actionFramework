package org.reaction.gklExample.api;
		...
		public class GklExampleSimSGApi extends SimSGAPI{
			
			public GklExampleSimSGApi() {
				super();
			...
			public void configureForHiPE() {
				...
				configurator.setIBeXHiPEGT("org.reaction.gklExample.api");
				configurator.setIBeXHiPEAsEngine("org.reaction.gklExample.api");
			}
			
			public void configureForDemocles() {
				configurator.setIBeXPMC();
				configurator.setIBeXDemoclesGT("org.reaction.gklExample.api");
				configurator.setIBeXDemoclesAsEngine("org.reaction.gklExample.api");
			}
