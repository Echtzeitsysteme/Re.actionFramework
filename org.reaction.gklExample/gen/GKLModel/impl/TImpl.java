...
public class TImpl extends AgentImpl implements T {
		...
		if (t_x_P_a != null && t_x_P_a.eIsProxy()) {
			...
			if (t_x_P_a != oldT_x_P_a) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GKLModelPackage.T__TXPA, oldT_x_P_a, t_x_P_a));
			}
		}
		return t_x_P_a;
	}
	...
	public NotificationChain basicSetT_x_P_a(P newT_x_P_a, NotificationChain msgs) {
		...
		t_x_P_a = newT_x_P_a;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GKLModelPackage.T__TXPA, oldT_x_P_a, newT_x_P_a);
	...
	public P getT_y_P_a() {
		if (t_y_P_a != null && t_y_P_a.eIsProxy()) {
			...
			if (t_y_P_a != oldT_y_P_a) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GKLModelPackage.T__TYPA, oldT_y_P_a, t_y_P_a));
			}
		}
		return t_y_P_a;
	}
	...
	public NotificationChain basicSetT_y_P_a(P newT_y_P_a, NotificationChain msgs) {
		...
		t_y_P_a = newT_y_P_a;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GKLModelPackage.T__TYPA, oldT_y_P_a, newT_y_P_a);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public K getT_x_K_a() {
		if (t_x_K_a != null && t_x_K_a.eIsProxy()) {
			...
			if (t_x_K_a != oldT_x_K_a) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GKLModelPackage.T__TXKA, oldT_x_K_a, t_x_K_a));
			}
		}
		return t_x_K_a;
	}
	...
	public NotificationChain basicSetT_x_K_a(K newT_x_K_a, NotificationChain msgs) {
		...
		t_x_K_a = newT_x_K_a;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GKLModelPackage.T__TXKA, oldT_x_K_a, newT_x_K_a);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public K getT_y_K_a() {
		if (t_y_K_a != null && t_y_K_a.eIsProxy()) {
			...
			if (t_y_K_a != oldT_y_K_a) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GKLModelPackage.T__TYKA, oldT_y_K_a, t_y_K_a));
			}
		}
		return t_y_K_a;
	}
	...
	public NotificationChain basicSetT_y_K_a(K newT_y_K_a, NotificationChain msgs) {
		...
		t_y_K_a = newT_y_K_a;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GKLModelPackage.T__TYKA, oldT_y_K_a, newT_y_K_a);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GKLModelPackage.T__TXPA:
				if (resolve) return getT_x_P_a();
				return basicGetT_x_P_a();
			case GKLModelPackage.T__TYPA:
				if (resolve) return getT_y_P_a();
				return basicGetT_y_P_a();
			case GKLModelPackage.T__TXKA:
				if (resolve) return getT_x_K_a();
