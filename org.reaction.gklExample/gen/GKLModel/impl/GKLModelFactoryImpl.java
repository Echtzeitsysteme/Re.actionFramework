...
public class GKLModelFactoryImpl extends EFactoryImpl implements GKLModelFactory {
	...
	public static GKLModelFactory init() {
		try {
			GKLModelFactory theGKLModelFactory = (GKLModelFactory)EPackage.Registry.INSTANCE.getEFactory(GKLModelPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case GKLModelPackage.P: return createP();
			case GKLModelPackage.T: return createT();
			case GKLModelPackage.K: return createK();
			case GKLModelPackage.US: return createU_s();
			case GKLModelPackage.PS: return createP_s();
			default:
