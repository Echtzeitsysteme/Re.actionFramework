...
public class KImpl extends AgentImpl implements K {
		...
		if (k_a_T_x != null && k_a_T_x.eIsProxy()) {
			...
			if (k_a_T_x != oldK_a_T_x) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GKLModelPackage.K__KATX, oldK_a_T_x, k_a_T_x));
			}
		}
		return k_a_T_x;
	}
	...
	public NotificationChain basicSetK_a_T_x(T newK_a_T_x, NotificationChain msgs) {
		...
		k_a_T_x = newK_a_T_x;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GKLModelPackage.K__KATX, oldK_a_T_x, newK_a_T_x);
	...
	public T getK_a_T_y() {
		if (k_a_T_y != null && k_a_T_y.eIsProxy()) {
			...
			if (k_a_T_y != oldK_a_T_y) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GKLModelPackage.K__KATY, oldK_a_T_y, k_a_T_y));
			}
		}
		return k_a_T_y;
	}
	...
	public NotificationChain basicSetK_a_T_y(T newK_a_T_y, NotificationChain msgs) {
		...
		k_a_T_y = newK_a_T_y;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GKLModelPackage.K__KATY, oldK_a_T_y, newK_a_T_y);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GKLModelPackage.K__KATX:
				if (resolve) return getK_a_T_x();
				return basicGetK_a_T_x();
			case GKLModelPackage.K__KATY:
				if (resolve) return getK_a_T_y();
