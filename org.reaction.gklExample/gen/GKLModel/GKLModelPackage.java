...
public interface GKLModelPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "platform:/resource/org.reaction.gklExample/model/GKL.ecore";
	 ...
	 * @ordered
	 */
	int P__ID = ReactionModelPackage.AGENT__ID;
	 ...
	 * @ordered
	 */
	int P__PATX = ReactionModelPackage.AGENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int P__PATY = ReactionModelPackage.AGENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int P_FEATURE_COUNT = ReactionModelPackage.AGENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int P_OPERATION_COUNT = ReactionModelPackage.AGENT_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int T__ID = ReactionModelPackage.AGENT__ID;
	 ...
	 * @ordered
	 */
	int T__TXPA = ReactionModelPackage.AGENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int T__TYPA = ReactionModelPackage.AGENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int T__TXKA = ReactionModelPackage.AGENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int T__TXU = ReactionModelPackage.AGENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int T__TXP = ReactionModelPackage.AGENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int T__TYKA = ReactionModelPackage.AGENT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int T__TYU = ReactionModelPackage.AGENT_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int T__TYP = ReactionModelPackage.AGENT_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int T_FEATURE_COUNT = ReactionModelPackage.AGENT_FEATURE_COUNT + 8;
	 ...
	 * @ordered
	 */
	int T_OPERATION_COUNT = ReactionModelPackage.AGENT_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int K__ID = ReactionModelPackage.AGENT__ID;
	 ...
	 * @ordered
	 */
	int K__KATX = ReactionModelPackage.AGENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int K__KATY = ReactionModelPackage.AGENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int K_FEATURE_COUNT = ReactionModelPackage.AGENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int K_OPERATION_COUNT = ReactionModelPackage.AGENT_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int US_FEATURE_COUNT = ReactionModelPackage.STATE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int US_OPERATION_COUNT = ReactionModelPackage.STATE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PS_FEATURE_COUNT = ReactionModelPackage.STATE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PS_OPERATION_COUNT = ReactionModelPackage.STATE_OPERATION_COUNT + 0;
