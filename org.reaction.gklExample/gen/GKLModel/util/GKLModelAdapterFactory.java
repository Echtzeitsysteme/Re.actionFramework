...
public class GKLModelAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected GKLModelSwitch<Adapter> modelSwitch =
		new GKLModelSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ReactionModel.Agent <em>Agent</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see ReactionModel.Agent
	 * @generated
	 */
	...
	/**
	 * Creates a new adapter for an object of class '{@link ReactionModel.State <em>State</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see ReactionModel.State
	 * @generated
	 */
