	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GKLModelPackage.P: {
				P p = (P)theEObject;
				T1 result = caseP(p);
				if (result == null) result = caseAgent(p);
			...
			case GKLModelPackage.T: {
				T t = (T)theEObject;
				T1 result = caseT(t);
				if (result == null) result = caseAgent(t);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GKLModelPackage.K: {
				K k = (K)theEObject;
				T1 result = caseK(k);
				if (result == null) result = caseAgent(k);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GKLModelPackage.US: {
				...
				if (result == null) result = caseState(u_s);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GKLModelPackage.PS: {
				...
				if (result == null) result = caseState(p_s);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
