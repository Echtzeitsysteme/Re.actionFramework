 ...
 * </p>
 * <ul>
 *   <li>{@link intermModel.impl.IntermInitialisationImpl#getCnt <em>Cnt</em>}</li>
 *   <li>{@link intermModel.impl.IntermInitialisationImpl#getInitPattern <em>Init Pattern</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntermInitialisationImpl extends IntermComponentImpl implements IntermInitialisation {
	...
	protected EClass eStaticClass() {
		return IntermModelPackage.Literals.INTERM_INITIALISATION;
	}
	...
	public void setCnt(int newCnt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IntermModelPackage.INTERM_INITIALISATION__CNT, oldCnt,
					cnt));
	}
			...
			if (initPattern != oldInitPattern) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							IntermModelPackage.INTERM_INITIALISATION__INIT_PATTERN, oldInitPattern, initPattern));
			}
		}
		return initPattern;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IntermModelPackage.INTERM_INITIALISATION__CNT:
			return getCnt();
		case IntermModelPackage.INTERM_INITIALISATION__INIT_PATTERN:
			if (resolve)
