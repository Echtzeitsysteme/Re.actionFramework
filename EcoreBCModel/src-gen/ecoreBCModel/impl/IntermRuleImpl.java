 ...
 * </p>
 * <ul>
 *   <li>{@link ecoreBCModel.impl.IntermRuleImpl#getName <em>Name</em>}</li>
 *   <li>{@link ecoreBCModel.impl.IntermRuleImpl#getRate <em>Rate</em>}</li>
 *   <li>{@link ecoreBCModel.impl.IntermRuleImpl#getLhs <em>Lhs</em>}</li>
 *   <li>{@link ecoreBCModel.impl.IntermRuleImpl#getRhs <em>Rhs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntermRuleImpl extends IntermComponentImpl implements IntermRule {
	...
	protected EClass eStaticClass() {
		return EcoreBCModelPackage.Literals.INTERM_RULE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreBCModelPackage.INTERM_RULE__NAME, oldName,
					name));
	}
	...
	public void setRate(double newRate) {
		...
		rate = newRate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreBCModelPackage.INTERM_RULE__RATE, oldRate,
					rate));
	}
	...
	public IntermPattern getLhs() {
		if (lhs != null && lhs.eIsProxy()) {
			...
			if (lhs != oldLhs) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EcoreBCModelPackage.INTERM_RULE__LHS,
							oldLhs, lhs));
			}
		}
		return lhs;
	...
	public void setLhs(IntermPattern newLhs) {
		...
		lhs = newLhs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreBCModelPackage.INTERM_RULE__LHS, oldLhs, lhs));
	}
	...
	public IntermPattern getRhs() {
		if (rhs != null && rhs.eIsProxy()) {
			...
			if (rhs != oldRhs) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EcoreBCModelPackage.INTERM_RULE__RHS,
							oldRhs, rhs));
			}
		}
		return rhs;
	...
	public void setRhs(IntermPattern newRhs) {
		...
		rhs = newRhs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreBCModelPackage.INTERM_RULE__RHS, oldRhs, rhs));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EcoreBCModelPackage.INTERM_RULE__NAME:
			return getName();
		case EcoreBCModelPackage.INTERM_RULE__RATE:
			return getRate();
		case EcoreBCModelPackage.INTERM_RULE__LHS:
			if (resolve)
				return getLhs();
			return basicGetLhs();
		case EcoreBCModelPackage.INTERM_RULE__RHS:
			if (resolve)
				return getRhs();
			return basicGetRhs();
		}
