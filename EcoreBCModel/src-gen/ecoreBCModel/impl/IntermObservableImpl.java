 ...
 * </p>
 * <ul>
 *   <li>{@link ecoreBCModel.impl.IntermObservableImpl#getName <em>Name</em>}</li>
 *   <li>{@link ecoreBCModel.impl.IntermObservableImpl#getObsPattern <em>Obs Pattern</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntermObservableImpl extends IntermComponentImpl implements IntermObservable {
	...
	protected EClass eStaticClass() {
		return EcoreBCModelPackage.Literals.INTERM_OBSERVABLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreBCModelPackage.INTERM_OBSERVABLE__NAME, oldName,
					name));
	}
			...
			if (obsPattern != oldObsPattern) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							EcoreBCModelPackage.INTERM_OBSERVABLE__OBS_PATTERN, oldObsPattern, obsPattern));
			}
		}
		return obsPattern;
	}
	...
	public void setObsPattern(IntermPattern newObsPattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreBCModelPackage.INTERM_OBSERVABLE__OBS_PATTERN,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EcoreBCModelPackage.INTERM_OBSERVABLE__NAME:
			return getName();
		case EcoreBCModelPackage.INTERM_OBSERVABLE__OBS_PATTERN:
			if (resolve)
